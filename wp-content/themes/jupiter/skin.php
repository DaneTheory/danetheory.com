...
.banner-slogan {
	font-size: {$option['banner_slogan_size']}px;
	color: {$option['banner_slogan_color']};
	text-transform: {$option['banner_slogan_transform']};
	font-weight: {$option['banner_slogan_weight']};
}
