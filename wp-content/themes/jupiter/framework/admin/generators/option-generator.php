...
<!-- Masterkey Header Section -->
        <div id="masterkey-header">
            ...
            <ul class="mk-help-links">
                <li class="mk-support"><a href="http://artbees.net/support"><?php _e( 'Help Desk', 'mk_framework' ); ?></a></li>
                <li class="mk-docs"><a href="http://artbees.net/themes/jupiter/docs"><?php _e( 'Documentation', 'mk_framework' ); ?></a></li>
            </ul>
...
?>
    ...
    <div class="mk-bg-edit-left">
      ...
      <div class="mk-bg-edit-option mk-bg-edit-option-stretch"> <span class="mk-bg-edit-label">
        ...
        <span class="mk-toggle-button"><input type="hidden" value="false" name="bg_panel_stretch" id="bg_panel_stretch"/></span>
        <div class="clearboth"></div>
      </div>
      <div class="clearboth"></div>
    </div>
