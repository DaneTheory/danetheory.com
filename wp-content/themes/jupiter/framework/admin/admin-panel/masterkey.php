...
$options = array(
  ...
  array(
    "type" => "start",
    "options" => array(
      "general" => __( "General", "mk_framework" ),
      "skining" => __( "Styling & <br /> Coloring", "mk_framework" ),
      "typography" => __( "Typography", "mk_framework" ),
      "portfolio" => __( "Portfolio", "mk_framework" ),
      "blog" => __( "Blog & <br /> News", "mk_framework" ),
      "advanced" => __( "Advanced", "mk_framework" ),
    ),
  ),
...
-------------------------------------------------------------*/
  ...
  array(
    "type" => "start_sub",
    "options" => array(
      "global_settings" => __( "Global Settings", "mk_framework" ),
      "header_toolbar" => __( "Header Toolbar", "mk_framework" ),
      "header_section" => __( "Header", "mk_framework" ),
      "sidebar" => __( "Custom Sidebars", "mk_framework" ),
      "footer" => __( "Footer", "mk_framework" ),
      "quick_contact" => __( "Quick Contact Form", "mk_framework" ),
    ),
  ),
  ...
  array(
    ...
    "default" => "Important news or anything!",
    "option_structure" => 'sub',
    "divider" => true,
    "type" => "text"
  ),
...
-------------------------------------------------------------*/
  ...
  array(
    "type" => "start_sub",
    "options" => array(
      "backgrounds_skin" => __( "Backgrounds", "mk_framework" ),
      "general_skin" => __( "General Coloring", "mk_framework" ),
      "skin_main_navigation_skin" => __( "Main Navigation", "mk_framework" ),
      "header_toolbar_skin" => __( "Header Toolbar", "mk_framework" ),
      "header_banner_skin" => __( "Page Title", "mk_framework" ),
      "sidebar_skin" => __( "Sidebar", "mk_framework" ),
      "footer_skin" => __( "Footer", "mk_framework" ),
      "misc_skin" => __( "Miscellaneous", "mk_framework" ),
  ...
  array(
    "name" => __( 'Banner Slogan', 'mk_framework' ),
    "desc" => __( "", "mk_framework" ),
    "id" => "banner_slogan_color",
    "default" => "#fff",
    "option_structure" => 'sub',
    "divider" => true,
    "type" => "color"
...
-------------------------------------------------------------*/
  ...
  array(
    "type" => "start_sub",
    "options" => array(
      "fonts" => __( "Fonts", "mk_framework" ),
      "general_typography" => __( "General Typography", "mk_framework" ),
      "main_navigation_typography" => __( "Main Navigation", "mk_framework" ),
      "page_introduce_typography" => __( "Page Title", "mk_framework" ),
      "sidebar_typography" => __( "Sidebar", "mk_framework" ),
      "footer_typography" => __( "Footer", "mk_framework" ),
...
-------------------------------------------------------------*/
  ...
  array(
    "type" => "start_sub",
    "options" => array(
      "portfolio_single" => __( "Portfolio Single Post", "mk_framework" ),
...
-------------------------------------------------------------*/
  ...
  array(
    "type" => "start_sub",
    "options" => array(
      "blog_general" => __( "Blog General Settings", "mk_framework" ),
      "blog_single_post" => __( "Blog Single Post", "mk_framework" ),
      "archive_posts" => __( "Archive", "mk_framework" ),
      "search_posts" => __( "Search", "mk_framework" ),

      "news_single" => __( "News Single Post", "mk_framework" ),
...
-------------------------------------------------------------*/
  ...
  array(
    "type" => "start_sub",
    "options" => array(
      "ucp" => __( "Under Construction Page", "mk_framework" ),
      "twitter_api" => __( "Twitter API", "mk_framework" ),
      "seo" => __( "SEO", "mk_framework" ),
      "custom_js" => __( "Custom JS", "mk_framework" ),
      "custom_css" => __( "Custom CSS", "mk_framework" ),
      "woocommrce" => __( "Woocommerce", "mk_framework" ),
      "export_options" => __( "Export Options", "mk_framework" ),
      "import_options" => __( "Import Options", "mk_framework" ),
      "troubleshooting" => __( "Troubleshooting", "mk_framework" ),
