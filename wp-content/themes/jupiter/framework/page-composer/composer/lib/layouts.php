...
class WPBakeryVisualComposerLayoutButton implements WPBakeryVisualComposerTemplateInterface {
    ...
    public function output( $post = null ) {
        ...
        $output = '<li><a id="'.$this->params['id'].'" data-element="vc_column" data-width="'.$this->params['id'].'" class="'.$this->params['id'].' clickable_layout_action dropable_column" href="#"><span>'.__( $this->params['title'], "mk_framework" ).'</span></a></li>';
        return $output;
    }
}
...
class WPBakeryVisualComposerTemplateMenuButton implements WPBakeryVisualComposerTemplateInterface {
    ...
    public function output( $post = null ) {
        if ( empty( $this->params ) ) return '';
        $output = '<li class="wpb_template_li"><a data-template_id="'.$this->id.'" href="#">'.__( $this->params['name'], "mk_framework" ).'</a> <span class="wpb_remove_template"><i class="icon-trash wpb_template_delete_icon">Delete</i> </span></li>';
        return $output;
    }
}
...
class WPBakeryVisualComposerElementButton implements WPBakeryVisualComposerTemplateInterface {
    ...
    public function output( $post = null ) {
        ...
        $output .= '<li><a data-element="' . $this->base . '" id="' . $this->base . '" class="dropable_el clickable_action'.$class.'" href="#">' . __( $this->params["name"], "mk_framework" ) .'</a></li>';
        return $output;
    }
}
...
class WPBakeryVisualComposerTemplateMenu implements WPBakeryVisualComposerTemplateInterface {
    ...
    public function output( $post = null ) {
        if ( empty( $this->params ) ) return '';
        $output =  '<li class="nav-header">'.__( 'Save', 'mk_framework' ).'</li>
                    <li id="wpb_save_template"><a href="#">'.__( 'Save current page as a Template', 'mk_framework' ).'</a></li>
                    <li class="divider"></li>
                ...
                <div class="navbar-inner">
                    <div class="container">
                        <div class="nav-collapse">
                            <ul class="nav">
                                <li class="dropdown">
                                    <a data-toggle="dropdown" class="dropdown-toggle wpb_popular_layouts" href="#"><i class="mk-icon-columns"></i>'.__( "Columns", "mk_framework" ).'<i class="mk-icon-caret-down"></i></a>
                                    <ul class="dropdown-menu mk-columns-nav">
                                        '.$this->getColumnLayouts().'
                                    </ul>
                                </li>
                                <li class="dropdown">
                                    <a data-toggle="dropdown" class="dropdown-toggle wpb_content_elements" href="#"><i class="mk-icon-plus-sign"></i>'.__( "Elements", "mk_framework" ).'<i class="mk-icon-caret-down"></i></a>
                                    <div class="dropdown-menu shortcode_elements">
                                    <form class="mk-filterform" action="#">
                                    <input autocomplete="off" placeholder="Type shortcode name to filter" type="text" class="page-composer-filter-field" value="" name="filter-by-name" id="mk-filter-by-name" />
                                    </form>
                                    <ul class="mk_shortcode_els">
                            ...
                            <ul class="nav" style="float:right">
                                <li class="dropdown">
                                    <a data-toggle="dropdown" class="dropdown-toggle wpb_templates" href="#"><i class="mk-icon-file"></i>'.__( 'Templates', 'mk_framework' ).'<i class="mk-icon-caret-down"></i></a>
...
class WPBakeryVisualComposerLayout implements  WPBakeryVisualComposerTemplateInterface {
    ...
    public function output( $post = null ) {
        ...
        foreach ( $mk_awesome_icons_list as $key => $option ) {
            if ( $key ) {
                $awesome_icon_list .= '<a href="#" rel="'.$key.'"><span>'.$key.'</span><i class="mk-'.$key.'"></i></a>';
            } else {
   ...
   <div style="display:none;">
    ...
    <input style="margin:10px"  autocomplete="off" size="60" placeholder="Type Icon Name to Filter" type="text" class="page-composer-icon-filter" value="" name="icon-filter-by-name" />
     <div class="mk-visual-selector mk-font-icons-wrapper" style="padding:10px; margin-bottom:20px;">
     '.$awesome_icon_list.'
        <input name="icon-holder" id="icon-holder" class="" type="hidden" value=""/>
     </div>
     <script type="text/javascript">
     ...
     <a href="#" class="mk-icon-holder-submit mk-button mk-ancilary dominant-color" style="color:#fff;margin:30px 0 0 10px;">Use Icon</a>
    </div>
    </div>
        <div class="metabox-composer-content">
                    ...
                    <div id="visual_composer_content" class="wpb_main_sortable main_wrapper row-fluid wpb_sortable_container">
                        <div style="margin:20px;">'.__( "Loading, please wait...", "mk_framework" ).'</div>
                    </div>
        ...
        $output .= '<span id="wpb_vc_loading" style="display:none;">'. __( 'Loading, please wait...', 'mk_framework' ) .'</span>';
