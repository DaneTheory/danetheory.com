...
class WPBakeryImagesMediaTab extends WPBakeryMediaTab {
    ...
    public function __construct() {
        ...
        $this->title = __('WPB Images', 'mk_framework');
        $this->pageLimit = 10;
    ...
    public function getContentList() {
        ...
        if ( $page_links )
            echo '<br/><div class="tablenav"><div id="wpb_spinner" style="display: none;"><img src="'.THEME_ADMIN_ASSETS_URI.'/images/mk-loading.gif" /> '.__("Loading, please wait...", "mk_framework").'</div><div class="tablenav-pages">' . $page_links . '</div></div>';
    ...
    public function formTemplate($type = 'file', $errors = null, $id = null)
    {
        ...
        <div class="wpb_media_tab row-fluid">
           ...
           <div class="<?php echo $this->get('single_image')=='true' ? 'span12' : 'span6' ?>">
            <h2 class="media-title"><?php _e('Click image from media library or drag it to the "Selected images" area', 'mk_framework'); ?></h2>
            ...
            <form enctype="multipart/form-data" method="post" action="<?php echo esc_attr($form_action_url); ?>" class="<?php echo $form_class; ?>" id="<?php echo $this->type; ?>-form">
                ...
                <h2 class="media-title"><?php _e('or add images from your computer.', 'mk_framework'); ?></h2>
                ...
                <p class="savebutton ml-submit" style="display:none;">
                    <!-- <?php submit_button( __( 'Save all changes', "mk_framework" ), 'button', 'save', false ); ?> -->
                </p>
            </form>
            </div>
            <script type="text/javascript">
            ...
            <div class="span6 selected_items">
                <h2><?php _e('Selected images', 'mk_framework') ?></h2>
                <p><?php _e('Use your mouse to drag images around to place them in the desired order.', 'mk_framework') ?></p>
                <div class="border">
                ...
                <br/>
                <button class="button-primary" id="vpb_send_selected_files"><?php _e('Update files list', 'mk_framework') ?></button>
            </div>
            <script type="text/javascript">
