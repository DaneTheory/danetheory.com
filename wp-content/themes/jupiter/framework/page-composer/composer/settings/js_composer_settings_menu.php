...
if ( current_user_can('switch_themes') ) : ?>
	<div id="custom-background" class="wrap">
		...
		<h2><?php _e("Visual Composer Settings Version", "mk_framework"); ?></h2>
		
		<form action="<?php echo str_replace( '%7E', '~', $_SERVER['REQUEST_URI']); ?>" method="post">
			<table class="form-table">
				<tbody>
					<tr valign="top">
						<th scope="row"><?php _e("Content types", "mk_framework"); ?></th>
						<td>
							<fieldset>
								<legend class="screen-reader-text"><span><?php _e("Post types", "mk_framework"); ?></span></legend>
								<?php
