...
include THEME_FRAMEWORK . "/page-composer/composer-options-includes.php";
include THEME_FRAMEWORK . "/page-composer/composer-options-typography.php";
include THEME_FRAMEWORK . "/page-composer/composer-options-loops.php";
include THEME_FRAMEWORK . "/page-composer/composer-options-slideshows.php";
include THEME_FRAMEWORK . "/page-composer/composer-options-general.php";
...
wpb_map( array(
        ...
        "class"     => "mk-woocommerce-recent-class",
        "params"    => array(
