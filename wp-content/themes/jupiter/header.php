   ...
   <?php endif; ?>
    ...
    <?php if($mk_options['header_toolbar_subscribe'] == 'true') : ?>
      <div class="mk-header-signup">
        <a href="#" id="mk-header-subscribe-button" class="mk-subscribe-link"><i class="mk-icon-envelope"></i><?php _e('Subscribe', 'mk_framework'); ?></a>
...
<div class="mk-header-inner">
  ...
  <div class="mk-classic-menu-wrapper mk-mega-nav" data-megawidth="<?php echo $mk_options['grid_width']; ?>"><?php theme_class('primary_menu'); ?></div>
  </div>
  <?php endif; ?>
<div class="clearboth"></div>
</div>
